...
const translations = {
  sr: {
    ...
    navAbout: "O meni",
    navContact: "Kontakt",
    tagline: "Web dizajn i izrada web stranica za vaš biznis",
  ...
  en: {
    ...
    navAbout: "About",
    navContact: "Contact",
    tagline: "Web design and website development for your business",
  ...
  de: {
    ...
    navAbout: "Über mich",
    navContact: "Kontakt",
    tagline: "Webdesign und Website-Erstellung für Ihr Unternehmen",
    lead: "Moderne, klare Websites, die Ihr Unternehmen von seiner besten Seite zeigen.",
    ...
    about: "Über mich",
    about1:
      "Ich bin Melanija, Webdesignerin, die einfache Dinge mag und sie gerne schön gestaltet.",
    about2:
      "Ich gestalte moderne, funktionale Websites für kleine Unternehmen – passend zu ihrem Stil und ihren Bedürfnissen.",
    about3:
      "Eine gute Website ist übersichtlich und einfach zu bedienen – und hinterlässt trotzdem einen starken ersten Eindruck.",
    whatIDo: "Was ich anbiete",
    workWeb: "Websites",
    workWebText: "Modern, übersichtlich und auf jedem Gerät optimal dargestellt.",
    workDesign: "Design",
    workDesignText: "Schlicht, durchdacht und auf Ihr Unternehmen abgestimmt.",
    workFeatures: "Funktionen",
    workFeaturesText:
      "Galerie, Kontaktformular, Google Maps, Reservierungen und mehr – je nach Bedarf.",
    contact: "Kontakt",
